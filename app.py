...
from forms import LoginForm, RegistrationForm, PasswordResetRequestForm, PasswordResetForm, TwoFactorForm, DataSharingSettingsForm, RewardsRedemptionForm, ManualPointsAdjustmentForm
...
@app.route('/rewards/settings', methods=['GET', 'POST'])
@login_required
    ...
    try:
        ...
        if form.validate_on_submit():
            ...
            if points_to_spend > user_points:
                ...
                return redirect(url_for('rewards_redeem'))
